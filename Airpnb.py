...
icon = Image.open(r"C:/Users/THINKPAD/Desktop/New folder/Airbnb Analysis/airbnb-678x381.png")
...
with st.sidebar:
    selected = option_menu("Menu", ["Home","Overview","Explore"], 
                           ...
                           styles={"nav-link": {"font-size": "18px", "text-align": "left", "margin": "-2px", "--hover-color": "#FF5A5F"},
                                   "nav-link-selected": {"background-color": "#FF5A"}}
                          )
    
# CREATING CONNECTION WITH MONGODB ATLAS AND RETRIEVING THE DATA
client = pymongo.MongoClient("mongodb+srv://jay:2425@cluster0.ftieeyn.mongodb.net/")
...
if selected == "Home":
    # Title Image
    st.image(r"C:\Users\THINKPAD\Desktop\New folder\Airbnb Analysis\airbnb-678x381.png")
    col1,col2 = st.columns(2,gap= 'medium')
    col1.markdown("## :blue[Domain] : Travel Industry")
    col1.markdown("## :blue[Technologies used] : Python, Pandas, Plotly, Streamlit, MongoDB")
    col1.markdown("## :blue[Overview] : To analyze Airbnb data using MongoDB Atlas")
    col2.markdown("Created by Jayakanthan")
    col2.markdown("#   ")
    col2.image(r"C:\Users\THINKPAD\Desktop\New folder\Airbnb Analysis\698437.png")
...
# EXPLORE PAGE
if selected == "Explore":
    st.markdown("## More details about the Airbnb data")
